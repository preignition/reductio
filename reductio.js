...
(function (global, factory) {
	...
	(global = global || self, global.reductio = factory());
	...
	const insertion = insertionsort_by(cr_identity);
	...
	function quicksort_by(f) {
	  var insertionsort = insertion.by(f);
	...
	const q = quicksort_by(cr_identity);
	q.by = quicksort_by;
	...
	crossfilter.insertionsort = insertion;
	crossfilter.permute = permute;
	crossfilter.quicksort = q;
	...
	function crossfilter() {
	  ...
	  function dimension(value, iterable) {
	    ...
	    var one, // lowest unset bit as mask, e.g., 00001000
	        ...
	        iterablesEmptyRows = [],
	        sort = q.by(function(i) { return newValues[i]; }),
